...
# Save results
output_path = "../../../output/question_pipeline_output/q152_q153_predictions/q152_q153_predictions_top_score_filtered.csv"
...
# Write results
filtered_unseen_df.to_csv(abs_out, index=False, encoding="utf-8")

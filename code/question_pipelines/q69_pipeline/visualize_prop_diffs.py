...
top_scored_df = pd.read_csv("../../../output/question_pipeline_output/q69_predictions/q69_predictions_filtered.csv")
...
def weighted_proportion(group):
    ...
    The proportion is computed as the weighted count of observations where `Q69`

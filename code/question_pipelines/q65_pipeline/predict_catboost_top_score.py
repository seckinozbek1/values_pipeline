...
# Calculate percentage above chance (adjusted chance threshold based on the class count)
...
# Semantic similarity filter function (Used only for scoring with 0 threshold)
...
# Save results
output_path = "../../../output/question_pipeline_output/q65_predictions/q65_predictions_top_score_filtered.csv"

...
valid_labels = ['Q65_1', 'Q65_2', 'Q65_3', 'Q65_4']

# Hardcoded label mappings (kept for reference, actual loaded below)
...
df = pd.read_csv("../../../data/labeled_data/Q65_mmr_selected_labeled_combined.csv")
...
def semantic_filter_per_label(sent_emb, keyphrase_embs, keyphrase_list, threshold=0.0):
    """
    Evaluate a sentence embedding against keyphrase embeddings by cosine similarity,
    returning a match flag, the maximum similarity score, and the matched keyphrase.
    ...
    Returns:
        tuple[bool, float, str|None]: 
            (True if max similarity ≥ threshold, maximum similarity score, matched keyphrase or None).
    """
...
# Save results
output_path = "../../../output/question_pipeline_output/q65_predictions/q65_predictions_unsg.csv"

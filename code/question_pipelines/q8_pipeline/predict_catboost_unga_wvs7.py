...
# Load train labeled embedding_hashes to exclude training data overlap
...
positive_class_probs = pred_probs_all[:, label2int['Q8_1']]  # positive class prob (Q8_1 mapped to 1)
...
def joint_score_filter(
    ...
    """
    Filter rows of a DataFrame based on a weighted joint score of confidence and similarity.
...
# Save results
output_path = "../../../output/question_pipeline_output/q8_predictions/q8_predictions_filtered.csv"

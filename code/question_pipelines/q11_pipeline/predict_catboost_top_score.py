...
# Take probability of positive class (Q11_1), which is encoded as 1
positive_class_probs = pred_probs_all[:, label2int['Q11_1']]  
threshold = 0.5
...
# Save results
output_path = "../../../output/question_pipeline_output/q11_predictions/q11_predictions_top_score_filtered.csv"

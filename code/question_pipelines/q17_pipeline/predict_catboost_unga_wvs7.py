...
train_df = pd.read_csv("../../../data/labeled_data/Q17_mmr_selected_labeled_combined.csv")
...
positive_class_probs = pred_probs_all[:, label2int['Q17_1']]  # positive class prob (Q17_1 mapped to 1)
threshold = 0.5
...
keep_columns = [
    ...
    'prediction_confidence', 'perc_diff_chance_abs', 'semantic_keyphrase_similarity', 'matched_keyphrase', 'joint_score'
]
final_df = final_df[keep_columns]

# Save results
output_path = "../../../output/question_pipeline_output/q17_predictions/q17_predictions_filtered.csv"
